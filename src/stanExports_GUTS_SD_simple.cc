...
#include "stanExports_GUTS_SD_simple.h"

RCPP_MODULE(stan_fit4GUTS_SD_simple_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("rstantools_model_GUTS_SD_simple")
